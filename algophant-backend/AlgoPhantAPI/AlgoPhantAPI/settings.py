"""
Django settings for AlgoPhantAPI project.
...
from Algorand.Algorand import Algorand
...
ROOT_URLCONF = 'AlgoPhantAPI.urls'
...
WSGI_APPLICATION = 'AlgoPhantAPI.wsgi.application'
